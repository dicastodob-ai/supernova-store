...
async function runResponsiveTests() {
  ...
  try {
    ...
    console.warn('⚠️ [PLAYWRIGHT] Navegador no disponible en este entorno local o faltan binarios.', err.message);
    console.log('ℹ️ Para ejecutar este test localmente: npx playwright install chromium && npm run test:responsive');
    return;
  }
